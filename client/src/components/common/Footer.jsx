      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Food Delivery Service</h3>
            <p className="text-gray-600 max-w-md">
              Connecting restaurants and customers through a seamless food delivery experience.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center text-sm text-gray-500">
          <p>&copy; {currentYear} Food Delivery Service. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
